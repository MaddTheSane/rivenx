...
- (MHKArchive*)archive { return [[_archive retain] autorelease]; }
...
- (void)_loadMovie
{
  ...
  if (!pthread_main_np())
    @throw [NSException exceptionWithName:NSInternalInconsistencyException reason:@"[RXMovieProxy _loadMovie] MAIN THREAD ONLY" userInfo:nil];
...
- (RXMovie*)proxiedMovie { return _movie; }
