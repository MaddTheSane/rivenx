...
- (NSDictionary*)compiledScript
{
  ...
  NSDictionary* script = [NSDictionary
      dictionaryWithObjectsAndKeys:pbuf, RXScriptProgramKey, [NSNumber numberWithUnsignedShort:[_decompiled_script count]], RXScriptOpcodeCountKey, nil];
  [pbuf release];
...
- (NSMutableArray*)decompiledScript
{
  ...
  while ((op = [_ops nextOpcode])) {
    ...
    [_current_block
        addObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithUnsignedShort:op->command], @"command", args, @"args", nil]];
  }
...
- (void)opcodeStream:(RXScriptOpcodeStream*)stream willEnterBranchForVariable:(uint16_t)var
{
  ...
  [_current_block addObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:[NSNumber numberWithUnsignedShort:RX_COMMAND_BRANCH], @"command",
                                                                              [NSNumber numberWithUnsignedShort:var], @"variable", cases, @"cases", nil]];
...
- (void)opcodeStream:(RXScriptOpcodeStream*)stream willEnterBranchCaseForValue:(uint16_t)value
{
  ...
  [cases addObject:[NSMutableDictionary dictionaryWithObjectsAndKeys:_current_block, @"block", [NSNumber numberWithUnsignedShort:value], @"value", nil]];
}
