...
- (void)_stopThreadRunloop { CFRunLoopStop(CFRunLoopGetCurrent()); }

- (NSThread*)scriptThread { return _scriptThread; }

#pragma mark -

- (NSURL*)worldBase { return _worldBase; }

- (NSURL*)worldCacheBase { return _worldCacheBase; }

- (NSURL*)worldSupportBase { return _worldSupportBase; }

- (void)_writeCachePreferences { [_cachePreferences writeToFile:[[[self worldCacheBase] path] stringByAppendingPathComponent:@"RivenX.plist"] atomically:NO]; }

- (BOOL)isInstalled { return [[_cachePreferences objectForKey:@"IsInstalled2"] boolValue]; }
...
- (NSDictionary*)extraBitmapsDescriptor { return _extrasDescriptor; }

- (NSCursor*)defaultCursor { return [self cursorForID:RX_CURSOR_FORWARD]; }

- (NSCursor*)openHandCursor { return [self cursorForID:RX_CURSOR_OPEN_HAND]; }

- (NSCursor*)invisibleCursor { return [self cursorForID:RX_CURSOR_INVISIBLE]; }
...
- (NSView<RXWorldViewProtocol>*)worldView { return _worldView; }

- (void*)audioRenderer { return _audioRenderer; }

- (RXRenderState*)cardRenderer { return _cardRenderer; }

- (BOOL)fullscreen { return _fullscreen; }

- (void)toggleFullscreenLegacyPath { [self _toggleFullscreenLegacyPath]; }

#pragma mark -

- (RXGameState*)gameState { return _gameState; }
...
- (void)_loadGameFadeInFinished { [(RXCardState*)_cardRenderer showMouseCursor]; }
...
- (NSDictionary*)stackDescriptorForKey:(NSString*)stackKey { return [_stackDescriptors objectForKey:stackKey]; }

- (RXStack*)activeStackWithKey:(NSString*)stackKey { return [_activeStacks objectForKey:stackKey]; }
  ...
  if (!stack) {
    error = [RXError
        errorWithDomain:RXErrorDomain
                   code:kRXErrFailedToInitializeStack
               userInfo:[NSDictionary dictionaryWithObjectsAndKeys:
                                          [error localizedDescription], NSLocalizedDescriptionKey, NSLocalizedString(@"UNINSTALL_RECOVERY", nil),
                                          NSLocalizedRecoverySuggestionErrorKey,
                                          [NSArray arrayWithObjects:NSLocalizedString(@"QUIT", @"quit"), NSLocalizedString(@"UNINSTALL", @"quit"), nil],
                                          NSLocalizedRecoveryOptionsErrorKey, [RXApplicationDelegate sharedApplicationDelegate], NSRecoveryAttempterErrorKey,
