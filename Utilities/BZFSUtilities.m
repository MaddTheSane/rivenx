...
BOOL BZFSFileURLExists(NSURL* url) { return BZFSFileExists([url path]); }
...
BOOL BZFSCreateDirectory(NSString* path, NSError** error) { return BZFSCreateDirectoryExtended(path, nil, 0, error); }

BOOL BZFSDirectoryURLExists(NSURL* url) { return BZFSDirectoryExists([url path]); }

BOOL BZFSCreateDirectoryURL(NSURL* url, NSError** error) { return BZFSCreateDirectory([url path], error); }
...
NSArray* BZFSContentsOfDirectoryURL(NSURL* url, NSError** error) { return BZFSContentsOfDirectory([url path], error); }
...
NSDictionary* BZFSAttributesOfItemAtURL(NSURL* url, NSError** error) { return BZFSAttributesOfItemAtPath([url path], error); }
